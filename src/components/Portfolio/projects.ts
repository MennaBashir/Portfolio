...
import matgar from "/assets/matgar.png";
...
export const myProjects = [
  {
    ...
    description:
      " Utilized Material-UI for building a modern, responsive user interface, providing a clean and customizable design system. Nivo charts are integrated to visualize complex data through interactive and customizable charts",
    link: "https://admin-dashboard-menna.netlify.app/",
  },
  {
    id: "p6",
    imag: matgar,
    title: "Matger Electronics",
    description: `A graduation project from the ITI training course, developed as a complete e-commerce platform with a dashboard for adding products
    My Role: Team Leader – Led the team and took full responsibility for the project’s successful execution.`,
    link: "https://matgaar.netlify.app/",
  },
  {
    id: "p5",
    imag: sirx,
